...
class LibraryCardFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Variables
        self.frame_code = 'library_card'
        self.frame_name = 'thẻ thư viện'
        self.columns = ('id', 'name', 'date_of_birth', 'gender', 'class', 'department', 'phone_number', 'address', 'date_of_registry', 'date_of_expiry')
        self.column_widths = [60, 160, 100, 100, 100, 100, 60, 60, 60, 60]    # 860
        self.labels = ['Mã thẻ', 'Họ tên', 'Ngày sinh', 'Giới tính', 'Lớp', 'Khoa', 'SĐT', 'Địa chỉ', 'Ngày cấp', 'Ngày hết hạn']
        self.vars = []
