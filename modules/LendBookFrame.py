...
class LendBookFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Variables
        self.frame_code = 'lend_slip'
        self.frame_name = 'phiếu mượn'
        self.columns = ('id', 'library_card_id', 'issue_date', 'due_date')
        self.column_widths = [80, 40, 80, 80]    # 860
        self.labels = ['Mã phiếu mượn', 'Mã thẻ', 'Ngày mượn', 'Ngày cần trả']
        self.vars = []
        ...
        # Variables_2
        self.frame_code_2 = 'lend_slip_detail'
        self.frame_name_2 = 'CT phiếu mượn'
        self.columns_2 = ('id', 'book_id')
        self.column_widths_2 = [80, 160]    # 860
        self.labels_2 = ['Mã phiếu mượn', 'Mã sách']
        self.vars_2 = []
        ...
        label_2 = ttk.Label(menu_upper_left_2, text='Nhấn vào dòng phiếu mượn để hiển thị chi tiết')
